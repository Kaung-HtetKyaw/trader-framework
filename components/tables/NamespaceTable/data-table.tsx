...
import { NamespaceWithIndex } from './columns';
...
interface NamespaceListDataTableProps {
  columns: ColumnDef<NamespaceWithIndex>[];
  data: NamespaceWithIndex[];
  isFetching: boolean;
  listSettings: ListSettings;
  pageInfo: PagePaginationInfo;
  fetchNextPage: () => void;
  onSortChange: (sortSettings: SortingState) => void;
  onRowClick: (row: NamespaceWithIndex) => void;
  rowKey: keyof NamespaceWithIndex;
  isLoading?: boolean;
  rowSelection?: Record<string, boolean>;
  onRowSelectionChange?: (rowSelection: Record<string, boolean>) => void;
}

const id = 'cluster-info-namespace-table';

const NamespaceListDataTable = ({
  columns,
  data,
  isFetching,
  fetchNextPage,
...
export default NamespaceListDataTable;
