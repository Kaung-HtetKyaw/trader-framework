...
import { getUpgradePlanSelectionCount, clearUpgradePlanSelections } from '@/signals/upgradePlan/selection';
import { useSignals } from '@preact/signals-react/runtime';
import { resetChatMessages } from '@/signals/chat/messages';

const UpgradePlanSelectedItemsCounter = () => {
  useSignals();

  const totalSelectedCount = getUpgradePlanSelectionCount();
...
export default UpgradePlanSelectedItemsCounter;
